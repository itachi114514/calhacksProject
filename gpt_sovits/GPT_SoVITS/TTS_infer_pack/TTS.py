...
class TTS:
    ...
    def _init_models(self,):
        ...
        self.init_t2s_weights(r"/home/itachi/Projects/python/Hikari/GPT-SoVITS/GPT_SoVITS/pretrained_models/GPT-SoVITS/gsv-v2final-pretrained/s1bert25hz-5kh-longer-epoch=12-step=369668.ckpt")
        # self.init_vits_weights(self.configs.vits_weights_path)
        self.init_vits_weights(r"/home/itachi/Projects/python/Hikari/GPT-SoVITS/GPT_SoVITS/pretrained_models/GPT-SoVITS/gsv-v2final-pretrained/s2G2333k.pth")
        # self.init_bert_weights(self.configs.bert_base_path)
        self.init_bert_weights(r"/home/itachi/Projects/python/Hikari/GPT-SoVITS/GPT_SoVITS/pretrained_models/GPT-SoVITS/chinese-roberta-wwm-ext-large")
        # self.init_cnhuhbert_weights(self.configs.cnhuhbert_base_path)
        self.init_cnhuhbert_weights(r"/home/itachi/Projects/python/Hikari/GPT-SoVITS/GPT_SoVITS/pretrained_models/GPT-SoVITS/chinese-hubert-base")
